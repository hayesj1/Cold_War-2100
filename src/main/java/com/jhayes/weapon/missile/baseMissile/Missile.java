...
public abstract class Missile implements IMissile, Comparable<Missile> {
	...
	protected Missile(PopulationHub homeBase, MissileTypes type) {
		...
		this.tier = (MissileTiers) JOptionPane.showInputDialog(null, "Choose the tier of your missile:", "Missile Tier",
				JOptionPane.QUESTION_MESSAGE, null, MissileTiers.values(), MissileTiers.std);
	}
	/** Stores the Missile in the main.java.com.jhayes.game's data structures */
	...
	/**
	 *
	 * @param player the main.java.com.jhayes.player whose missiles are to be gotten
	 * @return null if main.java.com.jhayes.player is null; otherwise the arrayList of missiles main.java.com.jhayes.game by main.java.com.jhayes.player
	 */
	...
	public final static class MissileID implements Comparable<MissileID>{
		private MissileTypes type = null;
		private int missileNumber = -1;

		public MissileID(MissileTypes type, int number) {
			this.type = type;
