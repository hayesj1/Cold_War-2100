...
import main.java.com.jhayes.weapon.missile.strikeMissile.BioMissile;
import main.java.com.jhayes.weapon.missile.strikeMissile.ConcentrationMissile;
import main.java.com.jhayes.weapon.missile.strikeMissile.NuclearMissile;
...
public final class PopulationHub implements IPopulationHub, Serializable {
    ...
    public PopulationHub(Player founder, String name) { this(founder, name, 0, 0); }
    public PopulationHub(Player founder, String name, double x, double y) { this(founder, name, new Point2d(x, y)); }
    public PopulationHub(Player founder, String name, Point2d pos) {
        this.owner = founder;
        this.cityName = name;
        this.pos = pos;
    ...
    private void produce() {
        if (this.missileProduction >= 1.0) {
            int temp = JOptionPane.showOptionDialog(null, "Choose a Missile:", "Missile Produced!",
                    JOptionPane.DEFAULT_OPTION, JOptionPane.QUESTION_MESSAGE, null, Missile.MissileTypes.values(), Missile.MissileTypes.BioMissile);
    ...
    public void targetedByMissile(IMissile m) {
        if (m instanceof Missile) {
            this.fearChange(m.getFearEffect());
        }
    }
    /**
    ...
    /**
     * NOTE: the returned arraylist is a reference to {@link Player#ownedCities} for the specific main.java.com.jhayes.player p.
     * Therefore, Player#ownedCities must be non-null at the time of this function call
     * @param p the main.java.com.jhayes.player whose popHubs are to be gotten
    ...
    public boolean equals(Object other) {
        ...
        return (this.owner.equals(otherPh.getOwner()) && this.cityName.equals(otherPh.getName()));
    }
    /**
     * @deprecated over kill equality checking; not necessary
