...
import main.java.com.jhayes.util.Predicates;
...
public final class ColdWar2100 implements Runnable {
						...
						if (!data.matches("\\*|\\*|\\*")) {
							switch(data) {
								...
								case "allegiance":
									...
									break;
								default:
									System.out.println("invalid data request sent! " + data);
									break;
							}
						}
	 ...
	 * <br>
	 * if a player loses, his/her id, it is <b>not</b> reused in the current game
	 * @return the next id
	 */
