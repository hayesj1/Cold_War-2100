package main.java.com.jhayes.player;

import main.java.com.jhayes.game.ColdWar2100;
import main.java.com.jhayes.gui.EnterAString;
import main.java.com.jhayes.gui.EnterAStringTypes;
...
public final class Player implements Comparable<Player>, Serializable {
	...
	/** @serial True if the main.java.com.jhayes.player has a capital; false otherwsie */
	private boolean hasCapital = false;

	/** @serial The empire the Player is allied to */
	private EnumEmpires allegiance = null;
	/** #serial The name of this main.java.com.jhayes.player's capital; allows for finding and identifying a main.java.com.jhayes.player's capital in a data structure of Pophubs */
	private String capitalName = null;

	/**  The capital popHub of a Player */
	private transient PopulationHub capital = null;
	/** The main main.java.com.jhayes.game HUD */
	private transient HUD mainGUI = null;
	/** The client associated this main.java.com.jhayes.player */
